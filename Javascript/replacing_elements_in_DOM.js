                ...
                /**
                 * Replaces the fifth <li> element in the DOM with a new <li> element containing custom text.
                 *
                 * Assumes there are at least five <li> elements present in the document.
                 */
    ...
    const thirdItem  = listItems[2];
                ...
                /**
                 * Replaces all <li> elements in the DOM with new content.
                 * The seventh <li> (index 6) is replaced with "Item six is changed",
                 * while all other <li> elements are replaced with "Replaced All".
                 *
                 * @function
                 */
                function replaceAll() {
